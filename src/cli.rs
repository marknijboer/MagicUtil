    ...
    App::new("MagicUtil")
        ...
        .subcommand(App::new("service")
            ...
            .setting(AppSettings::ArgRequiredElseHelp)
                ...
                .arg(Arg::new("untilrunning")
                    .alias("running")
                    .help("Waits until the MagicINFO service is running. This doesn't directly mean that it is accessible")
                    .long("untilrunning")
                )
                .arg(Arg::new("untilavailable")
                    .alias("available")
                    .help("Waits until the MagicINFO service is available")
                    .long("untilavailable")
                )
            )
        )
